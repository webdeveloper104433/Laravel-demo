...
class FlowsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('flows/index', ['flows' => $flows, 'page_name' => self::PAGE_NAME]);
    }
    ...
    {
        return view('flows/create', ['page_name' => self::PAGE_NAME]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('flows'))->with('success', 'A new flow was created.');
    }
    ...
    public function edit($id)
    {
        ...
        if (empty($flow)) {
            return redirect(route('flows'))->with('warning', 'warning.');
        }

        return view('flows/edit', ['flow' => $flow, 'page_name' => self::PAGE_NAME]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(url('flows/' . $id . '/edit'))->with('success', 'A flow was updated.');
    }
    ...
    {
        Flow::destroy($id);
        return redirect(url('flows'))->with('success', 'A flow was deleted.');
    }
    ...
    public function flow_entry_delete($flow_id, $flow_entry_id) {
        ...
        return redirect(url('flows/' . $flow_id . '/edit'))->with('success', 'A flow entry was deleted.');
