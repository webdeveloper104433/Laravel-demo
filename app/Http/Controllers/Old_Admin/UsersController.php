...
class UsersController extends Controller
{
    ...
    {
        return view('admin/users/index', ['users' => auth()->user()->users, 'page_name' => self::PAGE_NAME]);
    }
    ...
    {
        return view('admin/users/create', ['page_name' => self::PAGE_NAME]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin/users/edit', ['user' => $user, 'page_name' => self::PAGE_NAME]);
    }
